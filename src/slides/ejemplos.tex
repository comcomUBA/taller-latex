...
\begin{frame}[fragile]{Comenzando}
    ...
    se compone de un número indefinido,
    ...
    \end{tikzpicture}
    \vskip 2ex
    \fbox{El universo (que otros llaman la \emph{Biblioteca})(...).}
    \end{center}
...
\begin{itemize}
    ...
    \item El símbolo de porciento empieza un \emph{comentario} -- \LaTeX{} va a ignorar el resto de la línea.
\end{itemize}
