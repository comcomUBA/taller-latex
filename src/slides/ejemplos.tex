...
\begin{frame}[fragile]{Ejercicio}
    ...
    Clicken aca para abrir un template en Overleaf}}
    \end{center}
...
\begin{frame}[fragile]{Ejercicio}
A su vez, quizás queremos incluir gráficos en algún informe o presentación. Esto lo podemos hacer con el entorno \texttt{figure} y la función \textbackslash includegraphics. De esta forma:
